<x-layout :tabTitle='$tabTitle' :pageTitle='$pageTitle'>
  ...
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
      <h2 class="text-base/7 font-semibold text-gray-900">Edit the Post: {{$post->title}}</h2>
      <p class="mt-1 text-sm/6 text-gray-600">Use this form to update your post of the blog.</p>
